  ...
  it("golden file for 180x320 minimal: plate, emphasis, no karaoke", () => {
    ...
    expect(ass).toBe(
      [
        ...
        "Style: Default,Arial,11,&H00FFFFFF,&H00FFFFFF,&H73000000,&H73000000,0,0,0,0,100,100,0,0,1,0,0,2,11,11,60,1",
        "Style: Plate,Arial,11,&HFFFFFFFF,&HFFFFFFFF,&H73000000,&H73000000,0,0,0,0,100,100,0,0,3,2,0,2,11,11,60,1",
        "",
        "[Events]",
        "Format: Layer, Start, End, Style, Name, MarginL, MarginR, MarginV, Effect, Text",
        "Dialogue: 0,0:00:00.00,0:00:01.00,Plate,,0,0,0,,Hello world.",
        "Dialogue: 1,0:00:00.00,0:00:01.00,Default,,0,0,0,,{\\c&H0AD6FF&\\b1}Hello{\\c&HFFFFFF&\\b0} world.",
        "Dialogue: 0,0:00:01.00,0:00:01.80,Plate,,0,0,0,,Vector databases",
        "Dialogue: 1,0:00:01.00,0:00:01.80,Default,,0,0,0,,Vector {\\c&H0AD6FF&\\b1}databases{\\c&HFFFFFF&\\b0}",
        "Dialogue: 0,0:00:02.50,0:00:03.40,Plate,,0,0,0,,store embeddings",
        "Dialogue: 1,0:00:02.50,0:00:03.40,Default,,0,0,0,,store {\\c&H0AD6FF&\\b1}embeddings{\\c&HFFFFFF&\\b0}",
        "",
      ].join("\n"),
    );
  });
